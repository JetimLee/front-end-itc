...
const deleteBookByID_1 = require("../controllers/deleteBookByID");
const books_1 = require("../data/books");
const deleteRouter = (0, express_1.Router)();
exports.deleteRouter = deleteRouter;
deleteRouter.delete(`/book/:id`, (req, resp) => __awaiter(void 0, void 0, void 0, function* () {
    console.log("delete router was hit!!!");
    const { id } = req.params;
    const booksArray = yield (0, books_1.getBooks)();
    const idToNumber = parseFloat(id);
    const updatedBooks = yield (0, deleteBookByID_1.deleteBookById)(idToNumber, booksArray);
